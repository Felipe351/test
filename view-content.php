...
<html lang="pt-br">
  <head>
    ...
    <title>Search & Edit content</title>
  </head>
  <body>
    ...
    <?php
      ...
      $sql = "SELECT * FROM content WHERE title LIKE '%$view%'";
      ...
      <div class="row">
        <div class="col">
          ...
          <nav class="navbar navbar-light bg-light">
            <form class="form-inline" action="view-content.php" method="POST">
              ...
              <?php
                while ($line = mysqli_fetch_assoc($datas)) {
                  ...
                  echo "<tr>
                    ...
                    <td width='150px'>
                      <a href='edit-content.php?id=$id_content' class='btn btn-success btn-sm'>Edit it</a>
                      <a href='delete-content.php?id=$id_content' class='btn btn-danger btn-sm'>Delet it</a>
                    </td>
                  </tr>";
                }
              ?>
